...
augroup fswitch_au_group
    ...
    au BufEnter *.cc   call s:SetVariables('h,hh',    'reg:/src/include/,reg:|src|include/**|,ifrel:|/src/|../include|')
    ...
    au BufEnter *.h    call s:SetVariables('cc,c,cpp,m', 'reg:/include/src/,reg:/include.*/src/,ifrel:|/include/|../src|')
